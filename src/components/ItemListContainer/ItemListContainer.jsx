...
const ItemListContainer = (props) => {
    ...
    <div class="flex gap-y-6 flex-col items-center mt-8 h-full w-screen">
        ...
        <p class="flex w-4/5 font-sans text-white font-semibold drop-shadow-text-dark-glow text-xl text-center md:text-2xl md:text-center md:flex md:w-4/5">Pronto vas a poder disfrutar de una experiencia única</p>
